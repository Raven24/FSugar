...
int main(int argc, char *argv[])
{
	...
	qApp->setStyleSheet("QWidget { background: qlineargradient(x1: 0, y1: 0, x2: 0, y2: 1, stop:0 #333, stop:0.3 #232323 stop: 1 #333); color: #FFF; }"
						...
						"QMenuBar::item:selected { border: none; background: qradialgradient(cx:0.5, cy:0, radius: 1, fx:0.5, fy:0, stop:0 #777, stop:1 #333); border-radius: 4px; }"
						"QMenu { border: 1px solid #111; }"
						"QMenu::item { padding: 4px 4px 4px 22px; }"
						"QMenu::item:selected { background: #777; }"
						...
						"QTabBar::tab { background: qlineargradient(x1:0, y1:0, x2:0, y2:1, stop: 0 #444, stop: 1 #888); border-top-left-radius: 4px; border-top-right-radius: 4px; margin-left: 2px; margin-top: 3px; padding: 4px 8px; }"
